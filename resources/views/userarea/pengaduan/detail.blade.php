...
<div class="dashboard-main-body">
                    ...
                    <div class="d-flex align-items-center gap-8">
                        <div class="d-flex flex-column">
                            <ul class="d-flex flex-wrap align-items-center gap-32">
                                ...
                                <li class="text-white bg-info-400 border border-info-400 radius-4 px-8 py-4 text-sm line-height-1 fw-medium"><i class="fa fa-history"></i> {{$data->tanggal_laporan}}</li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="card mt-3 radius-12 overflow-hidden">
        <div class="card-body">
            <span>Laporan belum ditanggapi</span>
        </div>
    </div>
</div>
